...
public class Deposit {
    ...
    public Deposit(
        ...
        ,
         Account checkingAccount, double principalAmount, double interestRate, int depositDuration, Account bankAccount
         ) {
...
//     public static double calculateFixedTermDeposit(double depositAmount, int numberOfMonthsOnDeposit, double interestRate) {
//         double interest = depositAmount * (numberOfMonthsOnDeposit / 12.0) * (interestRate / 100);
//         return depositAmount + interest;
//     }
